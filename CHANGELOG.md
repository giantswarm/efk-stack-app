...
- Work around a Helm issue when `null` is used in the default values file. This caused problems wit upgrades in some scenarious.
...
[Unreleased]: https://github.com/giantswarm/efk-stack-app/compare/v0.5.2...HEAD
